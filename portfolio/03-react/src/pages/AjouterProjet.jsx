// AjouterProjet.jsx – Version finale avec accent amber
...
function AjouterProjet() {
  ...
  // Gestion upload image depuis la machine (base64)
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <div>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 transition text-sm"
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 transition"
            />
            {/* Aperçu badges technologies avec accent */}
            {form.technologies && (
              <div className="flex flex-wrap gap-2 mt-3">
                {form.technologies.split(',').map((tech, idx) => {
                  ...
                  return (
                    <span key={idx} className="bg-amber-50 text-amber-700 text-xs px-3 py-1 rounded-full border border-amber-200">
                      {cleanTech}
                    </span>
                  );
                })}
        ...
        <div className="bg-slate-50 px-6 sm:px-8 py-5 border-t border-slate-100 flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-medium transition disabled:opacity-60 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
          >
            {loading ? (
