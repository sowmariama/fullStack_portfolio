// AjouterProjet.jsx – Version design premium
...
function AjouterProjet() {
  ...
  // État pour la validation en temps réel (optionnel)
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-4">
          Complétez les informations ci-dessous pour ajouter une nouvelle réalisation à votre portfolio.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${
                errors.titre ? 'border-red-500 bg-red-50' : 'border-slate-300 focus:border-blue-500'
              }`}
            />
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="4"
              placeholder="Décrivez le projet, ses fonctionnalités, votre rôle..."
              className={`w-full px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${
            ...
            {form.image && (
              <div className="mt-3 relative group">
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition rounded-xl flex items-center justify-center">
                  <span className="text-white text-sm bg-black/60 px-3 py-1 rounded-full">Aperçu</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-slate-400 mt-1">
              Exemple : React, Tailwind, Express (les espaces seront automatiquement nettoyés)
            </p>
            {/* Aperçu des technologies sous forme de badges */}
            {form.technologies && (
        ...
        <div className="bg-slate-50 px-6 sm:px-8 py-5 border-t border-slate-100 flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-medium transition shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {loading ? (
