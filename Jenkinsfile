    ...
    post {
        success {
            emailext (
                ...
                mimeType: 'text/html',
                body: """<h2>Pipeline Jenkins Réussi</h2>
                         <p><b>Job:</b> ${env.JOB_NAME}</p>
                         <p><b>Build:</b> ${env.BUILD_NUMBER}</p>
                         <p><b>Statut:</b> <span style="color:green">SUCCES</span></p>
        ...
        failure {
            emailext (
                ...
                mimeType: 'text/html',
                body: """<h2>Pipeline Jenkins Échoué</h2>
                         <p><b>Job:</b> ${env.JOB_NAME}</p>
                         <p><b>Build:</b> ${env.BUILD_NUMBER}</p>
                         <p><b>Statut:</b> <span style="color:red">ECHEC</span></p>
